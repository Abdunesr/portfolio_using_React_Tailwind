    ...
    <div className="w-[85vw] md:w-[700px] bg-white rounded-md flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl">
      ...
      <div className="flex mt-10 mx-auto text-3xl gap-3 text-violet-400 font-bold">
        <button
          ...
          className="cursor-ponter hover:text-violet-500"
        >
          <FiChevronLeft />
        </button>
        <button
      ...
      <div className="mt-6">
        <button
          ...
          className="bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer px-10 py-2 font-bold text-white text-lg"
        >
          Surprised Me
        </button>
      </div>
